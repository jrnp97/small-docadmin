from docapp.forms.doctor.visiometria import (VisioForm, sintomas_section, ant_enfermedad_section,
                                             ant_uso_lentes_section,
                                             ant_extra_exams, agudeza_section, cronomatica_section)

from docapp.forms.doctor.audiology import (AudioForm,
                                           ananmesis_section,
                                           ant_familiar_section,
                                           ant_otro_section,
                                           exposicion_audifonos_section, exposicion_moto_section,
                                           exposicion_auto_section,
...
from docapp.forms.doctor.occupational import (OcupaForm,
                                              ...
                                              examen_fisico_general_section, examen_fisico_abdomen_section,
                                              examen_fisico_boca_section,
                                              examen_fisico_columna_section, examen_fisico_corazon_section,
                                              examen_fisico_cuello_section,
                                              examen_fisico_extremidades_section, examen_fisico_genito_unitario_section,
                                              examen_fisico_nariz_section, examen_fisico_neurologico_section,
                                              examen_fisico_oidos_section,
                                              ...
                                              conclusion_ingreso_section, conclusion_retiro_section,
