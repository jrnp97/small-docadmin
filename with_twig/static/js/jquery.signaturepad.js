...
function SignaturePad (selector, options) {
  ...
  function validateForm () {
    ...
    /*if (settings.drawOnly && output.length < 1) {
      ...
      valid = false
    }*///Comentar en caso de no querar validar 
...
$.fn.signaturePad.defaults = {
  ...
  , lineTop : 140 // Distance to draw the line from the top
  ...
  , errorMessageDraw : 'Ingrese la firma'//'Please sign the document' // The error message displayed when drawOnly and no signature is drawn
