    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examination_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='examenes_de_laboratorios', to='docapp.Examinacion')),
            ],
        ),
        migrations.CreateModel(
            name='Laboratorio',
        ...
        migrations.AddField(
            model_name='labexam',
            name='laboratorio_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='procesos', to='labapp.Laboratorio'),
        ),
        migrations.AddField(
            model_name='labexam',
            name='manejado_por',
